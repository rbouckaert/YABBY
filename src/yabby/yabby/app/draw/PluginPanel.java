...
//        g_distributions = new HashSet<Distribution>();
    ...
    public PluginPanel(YABBYObject plugin, Class<?> _pluginClass, List<YABBYObject> plugins, BeautiDoc doc) {
...
//		g_distributions.remove(sOldID);
    ...
    public PluginPanel(YABBYObject plugin, Class<?> _pluginClass, BeautiDoc doc) {
        this(plugin, _pluginClass, true, doc);
    }

    public PluginPanel(YABBYObject plugin, Class<?> _pluginClass, boolean bShowHeader, BeautiDoc doc) {
    ...
    public static void main(String[] args) {
        ...
        try {
            if (args.length == 0) {
                ...
                pluginPanel = new PluginPanel((YABBYObject) Class.forName(args[0]).newInstance(), Class.forName(args[0]), null);
            } else if (args.length == 2) {
                pluginPanel = new PluginPanel((YABBYObject) Class.forName(args[0]).newInstance(), Class.forName(args[1]), null);
            } else {
