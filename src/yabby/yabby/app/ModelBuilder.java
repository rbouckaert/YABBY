...
public class ModelBuilder extends JPanel {
    ...
    public static void main(String args[]) {
        ...
        yabby.app.draw.ModelBuilder drawTest = new yabby.app.draw.ModelBuilder();
        drawTest.init();
...
//        java.net.URL tempURL = ClassLoader.getSystemResource(beast.app.draw.ModelBuilder.ICONPATH + "/GenerationD.png");
        try {
            URL url = (URL) ClassLoader.getSystemResource(yabby.app.draw.ModelBuilder.ICONPATH + "/GenerationD.png");
