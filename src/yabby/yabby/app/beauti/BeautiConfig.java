...
public class BeautiConfig extends YABBYObject {
...
//		parseMap(m_editButtonStatus.get(), g_sEditButtonStatus);
    ...
    public List<BeautiSubTemplate> getInputCandidates(YABBYObject plugin, Input<?> input, Class<?> type) {
    ...
    public String getInputLabel(YABBYObject plugin, String sName) {
