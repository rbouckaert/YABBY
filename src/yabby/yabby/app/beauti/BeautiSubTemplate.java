...
public class BeautiSubTemplate extends YABBYObject {
...
//		}
    ...
    void removeSubNet(Object o) throws Exception {
        ...
        YABBYObject plugin = null;
        if (o instanceof YABBYObject) {
            plugin = (YABBYObject) o;
        }
    ...
    public YABBYObject createSubNet(PartitionContext partition, YABBYObject plugin, Input<?> input, boolean init) throws Exception {
        ...
        YABBYObject o = createSubNet(partition, doc.pluginmap, init);
        input.setValue(o, plugin);
        return o;
    }

    public YABBYObject createSubNet(PartitionContext partition, List<YABBYObject> list, int iItem, boolean init) throws Exception {
    ...
    public YABBYObject createSubNet(PartitionContext partition, boolean init) throws Exception {
        if (sXML == null) {
            // this is the NULL_TEMPLATE
            return null;
        }
    ...
    YABBYObject createSubNet(Alignment data, BeautiDoc doc, boolean init) {
        String sPartition = data.getID();
        HashMap<String, YABBYObject> sIDMap = doc.pluginmap;//new HashMap<String, Plugin>();
    ...
    private YABBYObject createSubNet(PartitionContext context, /*BeautiDoc doc,*/ HashMap<String, YABBYObject> sIDMap, boolean init) {
        ...
        YABBYObject plugin = doc.pluginmap.get(sID);
