...
public class BeautiConnector extends YABBYObject {
...
//	final static String AT_INITIALISATION_ONLY = "y";
     ...
     */
    public boolean isActivated(PartitionContext partitionContext, List<YABBYObject> posteriorPredecessors,
    		List<YABBYObject> likelihoodPredecessors, BeautiDoc doc) {
