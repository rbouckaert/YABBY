...
* is a very very good reason. */
     ...
     */
    public List<YABBYObject> parseTemplate(String sXML, HashMap<String, YABBYObject> sIDMap, boolean bInitialize) throws Exception {
...
//        }
     ...
     */
    public YABBYObject parseFragment(String sXML, boolean bInitialize) throws Exception {
        m_bInitialize = bInitialize;
        ...
        YABBYObject plugin = createObject(children.item(i), PLUGIN_CLASS, null);
        initPlugins();
        return plugin;
    } // parseFragment
    ...
    public List<YABBYObject> parseBareFragments(String sXML, boolean bInitialize) throws Exception {
        m_bInitialize = bInitialize;
        // parse the XML fragment into a DOM document
        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        doc = factory.newDocumentBuilder().parse(new InputSource(new StringReader(sXML)));
...
//            }
    ...
    void parseInputs(YABBYObject parent, Node node) throws Exception {
            ...
            for (int i = 0; i < atts.getLength(); i++) {
                ...
                if (!(sName.equals("id") ||
                    ...
                    if (sValue.startsWith("@")) {
                        ...
                        YABBYObject plugin = createObject(element, PLUGIN_CLASS, parent);
    ...
    void setInput(Node node, YABBYObject plugin, String sName, YABBYObject plugin2) throws XMLParserException {
        try {
    ...
    void setInput(Node node, YABBYObject plugin, String sName, String sValue) throws XMLParserException {
        try {
