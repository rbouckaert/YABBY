...
abstract public class YABBYObject {
    /**
     * set of YObjects that have this YObject in one of its Inputs *
     */
    public Set<YABBYObject> outputs = new HashSet<YABBYObject>();
...
//	}
    ...
    private String getCitations(HashSet<String> citations, HashSet<String> IDs) {
        ...
        try {
            for (YABBYObject plugin : listActivePlugins()) {
    ...
    public void getPredecessors(List<YABBYObject> predecessors) {
		predecessors.add(this);
		try {
			for (YABBYObject plugin2 : listActivePlugins()) {
