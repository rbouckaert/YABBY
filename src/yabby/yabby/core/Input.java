...
public class Input<T> {
     ...
     */
    @SuppressWarnings("unchecked")
    public void setValue(final Object value, final YABBYObject plugin) throws Exception {
        if (value == null) {
            if (this.value != null) {
                if (this.value instanceof YABBYObject) {
                    ((YABBYObject) this.value).outputs.remove(plugin);
                }
            }
            this.value = null;
            return;
...
//                }
                vector.add(value);
                if (value instanceof YABBYObject) {
                    ((YABBYObject) value).outputs.add(plugin);
                }
            }
                ...
                for (Object v : ((List<?>)value)) {
                    vector.add(v);
                    if (v instanceof YABBYObject) {
                        ((YABBYObject) v).outputs.add(plugin);
                    }
                }
            }
            else {
    ...
    private void setStringValue(final String sValue, final YABBYObject plugin) throws Exception {
        ...
        try {
            ...
            if (o instanceof YABBYObject) {
                ((YABBYObject) o).outputs.add(plugin);
            }
        } catch (Exception e) {
