...
public interface Parameter<T> {
	...
	@Description("A parameter represents a value in the state space that can be changed " +
	        "by operators.")
	public abstract class BaseP<T> extends StateNode implements Parameter<T>, Function {
	    /**
...
//		    }
	    ...
	    public BaseP<T> copy() {
	        try {
	            ...
	            BaseP<T> copy = (BaseP<T>) this.clone();
