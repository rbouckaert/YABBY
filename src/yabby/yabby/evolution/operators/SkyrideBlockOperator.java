...
/* Ported from Beast 1 GMRFSkyrideBlockUpdateOperator
 * A Metropolis-Hastings operator to update the log population sizes and 
 * precision parameter jointly under a Gaussian Markov random field prior
 */
@Description("Ported from Beast 1 GMRFSkyrideBlockUpdateOperator")
public class SkyrideBlockOperator extends Operator {
