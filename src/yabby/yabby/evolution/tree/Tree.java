...
public interface Tree {
    ...
    */
    ...
    public class BaseTree extends StateNode implements Tree {
        public Input<BaseTree> m_initial = new Input<BaseTree>("initial", "tree to start with");
         ...
         */
        protected yabby.evolution.tree.Node root;
        protected yabby.evolution.tree.Node storedRoot;
         ...
         */
        public BaseTree(String sNewick) throws Exception {
        ...
        public void log(int nSample, PrintStream out) {
            BaseTree tree = (BaseTree) getCurrent();
